#ifndef HALIDE__energy_h
#define HALIDE__energy_h
#include <stdint.h>
...
int energy(struct halide_buffer_t *_disparities_buffer, struct halide_buffer_t *_a_buffer, struct halide_buffer_t *_b_buffer, struct halide_buffer_t *_c_buffer, double _learning_rate, double _beta, double _gamma, int32_t _width, int32_t _height, double _sigma, struct halide_buffer_t *_point_tri_map_buffer, struct halide_buffer_t *_left_features_buffer, struct halide_buffer_t *_right_features_buffer, struct halide_buffer_t *_d_buffer, struct halide_buffer_t *_err_buffer, struct halide_buffer_t *_new_d_buffer) HALIDE_FUNCTION_ATTRS;
int energy_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *energy_metadata() HALIDE_FUNCTION_ATTRS;
