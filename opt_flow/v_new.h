#ifndef HALIDE__v_new_h
#define HALIDE__v_new_h
#include <stdint.h>
...
int v_new(struct halide_buffer_t *_img0_orig_buffer, struct halide_buffer_t *_img1_orig_buffer, struct halide_buffer_t *_prev_u_buffer, struct halide_buffer_t *_prev_v_buffer, struct halide_buffer_t *_next_u_buffer, struct halide_buffer_t *_next_v_buffer, struct halide_buffer_t *_u_buffer, struct halide_buffer_t *_v_buffer, struct halide_buffer_t *_v_new_buffer) HALIDE_FUNCTION_ATTRS;
int v_new_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *v_new_metadata() HALIDE_FUNCTION_ATTRS;
