#ifndef HALIDE__pipeline_h
#define HALIDE__pipeline_h
#include <stdint.h>
...
int v_new(struct halide_buffer_t *_img0_buffer, struct halide_buffer_t *_img1_buffer, struct halide_buffer_t *_prev_u_buffer, struct halide_buffer_t *_prev_v_buffer, struct halide_buffer_t *_next_u_buffer, struct halide_buffer_t *_next_v_buffer, struct halide_buffer_t *_u_buffer, struct halide_buffer_t *_v_buffer, struct halide_buffer_t *_v_new_buffer) HALIDE_FUNCTION_ATTRS;
