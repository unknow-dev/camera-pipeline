...
int main(int argc, char **argv) {
  ...
  fx(x, y) = (i16(img1(x - 3, y)) + i16(img1(x - 2, y)) * -9 + i16(img1(x - 1, y)) * 45 + i16(img1(x + 1, y)) * -45 + i16(img1(x + 2, y)) * 9 + i16(img1(x + 3, y)) * -1) / (60 * img1.width());

  Func fy;
  fy(x, y) = (i16(img1(x, y - 3)) + i16(img1(x, y - 2)) * -9 + i16(img1(x, y - 1)) * 45 + i16(img1(x, y + 1)) * -45 + i16(img1(x, y + 2)) * 9 + i16(img1(x, y + 3)) * -1) / (60 * img1.height());
  ...
  v_new.compile_to_static_library("v_new", {img0, img1, prev_u, prev_v, next_u, next_v, u, v}, "v_pipe");
